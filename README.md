Archer Duel (numele a ctual, posibile schimbari in viitor) este inspirat dupa Tank Stars, un joc turn based in care tu si oponentul jucati cu cate un tanc si trebuie sa va nimeriti lovind peste un deal, putand sa va mutati. Aici totusi, tu si oponentul sunteti doi arcasi ce va ascundeti dupa cate un perete si fie va nimeriti tragand peste perete, fie dati "peek" (ramaneti dezvaluiti o runda). Jocul va contine si cel putin o abilitate speciala, fie obtinuta prin a nimei untarget special, fie cumpararta
